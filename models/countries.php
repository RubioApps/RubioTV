...
class modelCountries extends Model
{
    ...
    {
        $this->page->title      = Text::_('COUNTRIES');
        $this->page->folder     = 'countries';
        ...
        foreach($this->page->data as $e)
            $e->link    = Factory::Link('channels', 'countries' , $e->id . ':' . $e->name);         
